...
[공통컬럼]
    ...
    CREATE TABLE rsrv(
      id             NUMBER(10) NOT NULL,        -- ID 
    --rsrv_date      DATE NOT NULL,              -- 예약날짜(삭제, c_date로 갈음)
      ...
      price          NUMBER(10) NOT NULL,        -- 가격(결제금액)
      rsrv_info      VARCHAR2(20) NOT NULL,      -- 결제 정보(결재수단: 토스/네이페이)
      appr_no        VARCHAR2(30) NOT NULL,      -- 승인번호
      buyer_name     VARCHAR2(30) NULL,	         -- 결제시 결제자 이름
      buyer_email    VARCHAR2(100) NULL,         -- 결제시 결제자 e-mail
